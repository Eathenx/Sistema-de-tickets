...
export function AgentDashboardView({ stats, tickets, onNavigate, onOpenTicket, user, loading, error, onRetry }) {
  return (
    <div>
      <div className="mb-5">
        <p className="text-base font-semibold text-[#1a1a1a] dark:text-white">Bienvenido, {user?.name}</p>
        <p className="text-xs text-[#7a6a50] dark:text-[#888] mt-0.5">
          Tus tickets asignados · {new Date().toLocaleDateString("es-ES", { weekday: "long", day: "numeric", month: "long" })}
        </p>
      </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="bg-[#c8b89a] dark:bg-[#1d1d1d] rounded-xl border border-[#b0a07a] dark:border-[#2a2a2a] overflow-hidden">
              <div className="px-4 py-3 border-b border-[#b0a07a] dark:border-[#2a2a2a] flex items-center">
                <span className="text-sm font-semibold text-[#1a1a1a] dark:text-white flex-1 uppercase tracking-wide">Mis tickets</span>
            ...
            <div className="bg-[#c8b89a] dark:bg-[#1d1d1d] rounded-xl border border-[#b0a07a] dark:border-[#2a2a2a] overflow-hidden">
              <div className="px-4 py-3 border-b border-[#b0a07a] dark:border-[#2a2a2a]">
                <span className="text-sm font-semibold text-[#1a1a1a] dark:text-white uppercase tracking-wide">Mis tickets por estado</span>
              </div>
